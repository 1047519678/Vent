 ...
 */
// document.write("<script type='text/javascript' src='../../phihong/js/js/components/mode-ecb.js'></script>");
// document.write("<script type='text/javascript' src='../../phihong/js/js/components/md5b.js'></script>");
// document.write("<script type='text/javascript' src='../../phihong/js/js/rollups/aes.js'></script>");
...
$(document).ready(function getdateurl() {
	// 禁用浏览器回退页面操作
	...
	window.history.pushState(json, "","?"+window.pwdString.encrypt(Date()))
	} else {
	alert("请使用谷歌浏览器")
...
// 	debugger
// 	// alert("push")
// 	if (document.URL.indexOf("Intelligentizephihong")>-1){
// 		debugger
// 		  window.top.location.href=window.top.location.href=document.URL.substring(0,document.length-21)
