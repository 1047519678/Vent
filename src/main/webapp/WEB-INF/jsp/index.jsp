...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>css/okadmin.css?randomId=<%=Math.random()%>">
</head>
<body class="layui-layout-body">
<input hidden id="EmpyNo" value="${EmpyNo}"/>
<input hidden id="memu" value="${memu}"/>
...
<div class="layui-layout layui-layout-admin okadmin blue_theme">
    ...
    <div class="layui-header okadmin-header">
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="ok-nav-item ok-hide-md">
                <div class="weather-ok">
                    <iframe frameborder="0" scrolling="no" class="iframe-style" src="pages/weather.html"
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="no-line layui-nav-item">
                <a href="javascript:">
                    <img id="ruserimg" src="<%=basePath%>apigetimg" class="layui-nav-img">
                </a>
                <dl id="userInfo" class="layui-nav-child">
                    <%--                    <dd><a lay-id="u-1" href="javascript:" data-url="<%=basePath%>pages/member/user.html">个人中心<span class="layui-badge-dot"></span></a></dd>--%>
                    <%--                    <dd><a lay-id="u-2" href="javascript:" data-url="<%=basePath%>pages/member/user-info.html">基本资料</a></dd>--%>
                    <dd><a lay-id="u-3" href="javascript:" data-url="<%=basePath%>controlluserchangepasswod">修改密码</a>
                    </dd>
    ...
    <div class="layui-side layui-side-menu okadmin-bg-20222A ok-left">
        <div class="layui-side-scroll okadmin-side">
            <div class="okadmin-logo">达宏电子</div>
            <div class="user-photo">
                <a class="img" title="我的头像">
                    <img id="userimg" src="<%=basePath%>apigetimg" class="userAvatar" onclick="updateimg()">
                </a>
                <p><span class="userName">欢迎登录 ${user}</span></p>
            </div>
            <!--左侧导航菜单-->
            <ul id="navBar" class="layui-nav okadmin-nav okadmin-bg-20222A layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:" lay-id="1" data-url="/Phihong/console">
        ...
        <div class="layui-tab ok-tab" lay-filter="ok-tab" lay-allowClose="true" lay-unauto>
            ...
            <ul id="tabTitle" class="layui-tab-title ok-tab-title not-scroll">
                <li class="layui-this" lay-id="1" tab="index">
                    <i class="ok-icon">&#xe654;</i>
                    <cite is-close=false>引导页</cite>
                </li>
            </ul>

            <div id="tabContent" class="layui-tab-content ok-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe src='/Phihong/console' frameborder="0" scrolling="yes" width="100%"
                            height="100%"></iframe>
                </div>
            </div>
        </div>
    ...
    <div class="layui-footer okadmin-text-center">
        Copyright ©2020 v4.0 版权所有.达宏资讯课
...
<script src="<%=basePath%>js/okadmin.js?randomId=<%=Math.random()%>"></script>
<script>
    function updateimg() {
        var okLayer = layui.okLayer;
        okLayer.open("更新用户头像", "/Phihong/Controllerimg", "40%", "50%", null, function () {
