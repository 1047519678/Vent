...
<div class="page-fill forget" id="login">
    <form class="layui-form verify-user-form">
        ...
        <div class="layui-form-item input-item">
            ...
            <input type="text" class="layui-input" id="username" name="username" placeholder="" autocomplete="off"
                   lay-verify="required">
        </div>
        <div class="layui-form-item input-item">
            <label for="phone">请输入手机号码</label>
            <input type="text" class="layui-input" id="phone" name="text" placeholder="" autocomplete="off"
                   lay-verify="required|phone" maxlength="11">
        </div>
        <div class="layui-form-item input-item code-box">
            <label for="captcha">请输入验证码</label>
            <input type="text" class="layui-input" id="captcha" name="captcha" placeholder="" autocomplete="off"
    ...
    <form class="layui-form reset-password-form">
        ...
        <div class="layui-form-item input-item">
            ...
            <input type="password" class="layui-input" id="password" name="password" placeholder="" autocomplete="off"
                   lay-verify="required|password">
        </div>
        <div class="layui-form-item input-item">
            <label for="comPassword">请确认密码</label>
            <input type="password" class="layui-input" id="comPassword" name="password" placeholder=""
                   autocomplete="off" lay-verify="required|comPassword">
        </div>
        <div class="layui-form-item">
