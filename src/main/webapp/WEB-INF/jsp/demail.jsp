...
<script>
    layui.use(["element", "table", "form", "laydate", "okLayer", "okUtils", "okMock"], function () {
        ...
        table.on("tool(tableFilter)", function (obj) {
            ...
            switch (obj.event) {
                case "off":
                    var json={"EmpyNo":obj.data.EmpyNo,"table":"tdemailstate","state":"1"}
                    okUtils.ajax("/update_pushstate", "post", json, true)
                    break;
                case "on":
                    var json={"EmpyNo":obj.data.EmpyNo,"table":"tdemailstate","state":"0"}
                    okUtils.ajax("/update_pushstate", "post",json, true)
                    break;
            }
