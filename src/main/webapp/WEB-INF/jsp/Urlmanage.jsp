    ...
    layui.use(["element", "table", "form", "laydate", "okLayer", "okUtils", "okMock"], function () {
        ...
        let userTable = table.render({
            ...
            cols: [[
                ...
                {field: "urlid", title: "列表ID", width: 100},
                {field: "gtitle", title: "父名称", width: 150},
                {field: "title", title: "列表名称", width: 300},
                {field: "href", title: "列表地址", width: 300},
                {field: "fontFamily", title: "字体样式", width: 100},
                {field: "icon", title: "图标样式", width: 100, sort: true, totalRow: true, templet: "#statusTpl2"},
                {field: "spread", title: "展开状态", width: 100, sort: true, totalRow: true, templet: "#statusTpl"},
            ]],
            height: 650,
        });
